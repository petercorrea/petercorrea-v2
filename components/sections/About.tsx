...
const content = (
  <div className="mr-8 ml-0">
    <p className="dark:text-stone-400 text-stone-500 inline">
    ...
    <p className="inline dark:text-stone-400 text-stone-500">
    ...
    <p className="inline dark:text-stone-400 text-stone-500">and {''}</p>
